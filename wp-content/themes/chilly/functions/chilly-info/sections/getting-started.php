...
<div id="getting_started" class="chilly-tab-pane active">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<h1 class="chilly-info-title text-center"><?php echo __('About the Chilly theme','chilly'); ?><?php if( !empty($chilly['Version']) ): ?> <sup id="chilly-theme-version"><?php echo esc_attr( $chilly['Version'] ); ?> </sup><?php endif; ?></h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
				...
				<h1 style="margin-top: 73px; background: #0085ba;border-color: #0073aa #006799 #006799; color: #fff; padding: 5px 10px;"><?php esc_html_e( "Getting Started", 'chilly' ); ?></h1></a>
				<div>
				...
				<p><a target="_blank" href="<?php echo esc_url( admin_url( 'customize.php' ) ); ?>" class="button button-primary" style="padding: 7px 15px;height: 40px; font-size: 16px;"><?php esc_html_e( 'Go to the Customizer','chilly');?></a></p>
				</div>
				</div>
			</div>
			<div class="col-md-6">
				<div class="chilly-tab-pane-half chilly-tab-pane-first-half">
				<img src="<?php echo esc_url( get_stylesheet_directory_uri() ) . '/functions/chilly-info/img/chilly.png'; ?>" alt="<?php esc_html_e( 'chilly theme', 'chilly' ); ?>" />
				</div>
			</div>	
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6"> 
				<div class="chilly-tab-pane-half chilly-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Lite Demo','chilly'); ?></p></a>
					...
					<p class="info-text"><?php echo __('PRO Demo','chilly'); ?></p></a>
			...
			<div class="col-md-6">	
				...
				<div class="chilly-tab-pane-half chilly-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Your feedback is valuable to us','chilly'); ?></p></a>
					...
					<p class="info-text"><?php echo __('Premium Theme Support','chilly'); ?></p></a>
				</div>
			</div>
			...
			<div class="col-md-6">	
				...
				<div class="chilly-tab-pane-half chilly-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Premium Theme Details','chilly'); ?></p></a>
